			    ...
			    <td colspan="3">
				    <table  border="0" width="100%" border="1">
				        <tr>
							...
							<td width="5%"><a href="buyer.html"><img src="../image/b.png" width="50"></a></td>
				        </tr>		
				    </table>
				...
				<td width="50%" height="100%">
					<table height="100%" width="100%" border="0">
				        ...
				        <td >						
						 <a>Account</a><br/>
	                          <br/>
							<a>Name</a><input value="John Bob"/><br/><br/>
							<a>Email:</a><input value="John@gmail.com"/><br/><br/>
							<input type="checkbox"/><a>Vacation mood</a><br/>
							<br/>
